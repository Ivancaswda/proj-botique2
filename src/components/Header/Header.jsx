...
const Header = () => {
    ...
    useEffect(() => {
        // При загрузке страницы извлекаем имя пользователя из localStorage


        setFirstLetter(userName ? userName.charAt(0).toUpperCase() : '!' );
    }, []);
    ...
    return (
        <div>
            <div className='w-100%  z-200 flex flex-col p-4 sm:p-2'>
                ...
                <div ref={headerRef} className={`first-navbar flex items-center justify-between ${isSticky ? 'stickyHeader' : 'RDelative'} `}>
                    ...
                    <div className='center-clauses-container flex items-center'>
                        <ul className=' hidden  lg:flex items-start  gap-7 font-semibold'>
                            ...
                            <NavLink className="hover:no-underline hover:text-current" to='/contact'><p>Связаться с нами</p>
                                <hr className='border-b-2 border-blue-500 hidden'/>
                            </NavLink>
                        </ul>
                    </div>
                            ...
                            {!globalUser ? (<Link to='/login'>
                                ...
                                (userName !== '' ? (
                                        ...
                                        <div
                                            ...
                                            className={`w-6 rounded-3xl  text-lg bg-primary  text-white flex justify-center items-center  `}>
                                            <b>{firstLetter ? firstLetter : ''}</b>
