...
const Cart = () => {
    ...
    const handleInputChange = (event) => {
        setText(event.target.value); // Обновляем текст
    };

    const handleInputBlur = () => {
        setIsEditing(false); // Завершаем редактирование при потере фокуса
    };
                                    ...
                                    <div className='w-100'>
                                        <div className='flex justify-between items-center '>
                                            ...
                                            <div className='flex items-center gap-6'>
                                                <button onClick={() => {
                                                    updateQuantity(item._id, item.delOption, item.quantity - 1)
                                        ...
                                        <div className='flex flex-col items-start justify-start gap-5 mt-2 '>
                                            ...
                                            <p>{productData.description.slice(0, 11)}</p>
                                            <div className='w-full flex items-center justify-start gap-5'>
                                                ...
                                                <svg className='cursor-pointer' onClick={() => {
                                                    updateQuantity(item._id, item.delOption, 0) // to remove this product we provide zero
                                                ...
                                                <div className='flex items-start w-full'>
                                                    <p className='text-gray-500 font-semibold'>{item.delOption}</p>
                                                </div>
                ...
                <div className='flex justify-end bg-gray-100 p-6 rounded-2xl '>
                    <div className='w-full sm:w-[300px]'>
                        ...
                        <div className='w-full text-center flex items-center justify-center mt-4'>
                            ...
                            <Link to={ globalUser ? ('/place-order') : ('/login') } >
                                <button onClick={() => {
                                    if (!globalUser) {
                                        toast.error('У вас должен быть аккаунт перед тем как делать заказ!')
                                    }
                                }} className='bg-blue-700 text-white text-lg px-16 py-2 rounded-lg'>Перейти к
                                    оплате
                                </button>
                            </Link>
                        </div>
                    ...
                    <div className=' p-4 ' style={{width: '70%'}}>
                        ...
                        { globalUser ?
                            (<div className='bg-gray-100 p-4  ' style={{width: '80%'}}>
                                ...
                                <div className='flex  gap-2  background'>
                                    <div onClick={() => {
                                 ...
                                 <div  className='flex items-center  mb-8'>
                                     <div className='flex items-center gap-2'>
                                         ...
                                         <button className='px-3 py-2 bg-blue-700 text-white rounded-lg font-semibold'>
                                                Создать аккаунт
                                         </button>
                                     </div>
                                 </div>
                                ...
                                <h1>Домашний Адрес:</h1>
                                    ...
                                    <div style={{display: "flex", alignItems: "center", gap: "10px"}}>
                                        ...
                                        {!isAdressEditing ? (
                                            ...
                                            >
          {'Вы пока  не установили адрес!'}
        </span>
                                        ) : (
                                            <InputMask mask="***********, **********, **********, 999"
                                                       maskChar=" "
                                                       placeholder="Введите адрес (Регион, Город, Улица, Дом)"
                                                       className='border border-zinc-300 rounded w-full p-1 text-sm mt-1 text-gray-700'
                                                       required={true}
                                                        type='text'
                                                       id="address"
